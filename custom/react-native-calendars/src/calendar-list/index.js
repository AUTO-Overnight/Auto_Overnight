...
const CalendarList = (props, ref) => {
    ...
    /** FlatList props */
    testID, style: propsStyle, horizontal = false, onLayout, removeClippedSubviews, pagingEnabled, scrollEnabled = true, nestedScrollEnabled = true, scrollsToTop = false, keyboardShouldPersistTaps, keyExtractor = (_, index) => String(index), onEndReachedThreshold, onEndReached } = props;

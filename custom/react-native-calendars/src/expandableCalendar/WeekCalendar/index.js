...
class WeekCalendar extends Component {
    ...
    renderItem = ({ item }) => {
        ...
        return (<Week {...others} key={item} current={item} firstDay={firstDay} style={this.getWeekStyle(this.containerWidth, style)} onDayPress={onDayPress} context={currentContext} numberOfDays={context.numberOfDays} timelineLeftInset={context.timelineLeftInset}/>);
    };
